...
static void aes128_init(struct aes128 *ctx, const void *k){
    __m128i key, gen;
...
static void aes128_encrypt(struct aes128 *ctx, void *pt, const void *ct){
...
static void aes128_decrypt(struct aes128 *ctx, void *ct, const void *pt){
